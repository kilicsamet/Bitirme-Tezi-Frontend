...
const ModelXUpdate = () => {
    ...
    const [modelXDetails, setModelXDetails] = useState([]);
    const fetchModelX = async () => {
        ...
        setModelXDetails(response.data)
    }
    useEffect(() => {
        fetchModelX();
    }, [])
                                    ...
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item">
                                                <Link to={"/admin/model-x"} >model-x</Link>
                                            </li>
                                            <li className="breadcrumb-item active">Model-x Düzenle</li>
                                        </ol>
                                    </div>
                                </div>
                            </CardBody>
                                        ...
                                        <Row>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarName" className="form-control" id="AraclarName"
                                                    defaultValue={modelXDetails[0]?.AraclarName}
                                                    placeholder=""
                                                />
                                            </div>
                                            <div className="mb-3">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarYil" className="form-control" id="AraclarYil"
                                                    placeholder=""
                                                    defaultValue={modelXDetails[0]?.AraclarYil}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarFiyat" className="form-control" id="AraclarFiyat"
                                                    placeholder=""
                                                    defaultValue={modelXDetails[0]?.AraclarFiyat}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarRenk" className="form-control" id="AraclarRenk"
                                                    defaultValue={modelXDetails[0]?.AraclarRenk}
                                                    />
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input name="AraclarDurum" type="select" className="form-control"
                                                    id="AraclarDurum"
                                                >
                                                     <option value="Sıfır" selected={modelXDetails[0]?.AraclarDurum==="Sıfır"?true:false}>Sıfır</option>
                                                    <option value="İkinci El" selected={modelXDetails[0]?.AraclarDurum==="İkinci El"?true:false}>İkinci El</option>
                                                </Input>
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarHiz" className="form-control" id="AraclarHiz"
                                                    defaultValue={modelXDetails[0]?.AraclarHiz}
                                                    />
                                            </div>
                                            <div className="mb-3">
