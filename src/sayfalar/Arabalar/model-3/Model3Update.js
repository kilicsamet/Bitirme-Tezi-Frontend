...
const Model3Update = () => {
    ...
    const [model3Details, setModel3Details] = useState([]);
    const fetchModel3 = async () => {
        ...
        setModel3Details(response.data)
    }
    useEffect(() => {
        fetchModel3();
    }, [])
                                ...
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            ...
                                            <li className="breadcrumb-item active">Model-3 Düzenle</li>
                                        </ol>
                                    </div>
                                </div>
                            </CardBody>
                                        ...
                                        <Row>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarName" className="form-control" id="AraclarName"
                                                    defaultValue={model3Details[0]?.AraclarName}
                                                    placeholder=""
                                                />
                                            </div>
                                            <div className="mb-3">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarYil" className="form-control" id="AraclarYil"
                                                    placeholder=""
                                                    defaultValue={model3Details[0]?.AraclarYil}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarFiyat" className="form-control" id="AraclarFiyat"
                                                    placeholder=""
                                                    defaultValue={model3Details[0]?.AraclarFiyat}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarRenk" className="form-control" id="AraclarRenk"
                                                    defaultValue={model3Details[0]?.AraclarRenk}
                                                    />
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input name="AraclarDurum" type="select" className="form-control"
                                                    id="AraclarDurum"
                                                >
                                                    <option value="Sıfır" selected={model3Details[0]?.AraclarDurum==="Sıfır"?true:false}>Sıfır</option>
                                                    <option value="İkinci El" selected={model3Details[0]?.AraclarDurum==="İkinci El"?true:false}>İkinci El</option>
                                                </Input>
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarHiz" className="form-control" id="AraclarHiz"
                                                    defaultValue={model3Details[0]?.AraclarHiz}
                                                    />
                                            </div>
                                            <div className="mb-3">
