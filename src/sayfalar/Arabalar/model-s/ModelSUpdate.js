...
const ModelSUpdate = () => {
    ...
    const fetchModelS = async () => {
        ...
        setModelSDetails(response.data)
    }
    useEffect(() => {
        fetchModelS();
    }, [])
                                    ...
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item">
                                                <Link to={"/admin/model-s"} >model-s</Link>
                                            </li>
                                            <li className="breadcrumb-item active">Model-s Düzenle</li>
                                        </ol>
                                    </div>
                                </div>
                            </CardBody>
                                        ...
                                        <Row>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarName" className="form-control" id="AraclarName"
                                                    defaultValue={modelSDetails[0]?.AraclarName}
                                                    placeholder=""
                                                />
                                            </div>
                                            <div className="mb-3">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarYil" className="form-control" id="AraclarYil"
                                                    placeholder=""
                                                    defaultValue={modelSDetails[0]?.AraclarYil}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarFiyat" className="form-control" id="AraclarFiyat"
                                                    placeholder=""
                                                    defaultValue={modelSDetails[0]?.AraclarFiyat}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarRenk" className="form-control" id="AraclarRenk"
                                                    defaultValue={modelSDetails[0]?.AraclarRenk}
                                                    />
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input name="AraclarDurum" type="select" className="form-control"
                                                    id="AraclarDurum" defaultValue={modelSDetails[0]?.AraclarDurum}
                                                >
                                                    <option value="Sıfır" selected={modelSDetails[0]?.AraclarDurum==="Sıfır"?true:false}>Sıfır</option>
                                                    <option value="İkinci El" selected={modelSDetails[0]?.AraclarDurum==="İkinci El"?true:false}>İkinci El</option>
                                                </Input>
                                            </div>
                                            <div className="mb-3">
                                                ...
                                                <Input type="text" name="AraclarHiz" className="form-control" id="AraclarHiz"
                                                    defaultValue={modelSDetails[0]?.AraclarHiz}
                                                    />
                                            </div>
                                            <div className="mb-3">
